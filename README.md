...
Part 3:
For my first page, I removed the imput text fields and replaced them with buttons for menu and to view the menu. I added two more screens for ManageMenu and FilterMenu where the chef is able to add menu items and enables the users to serches for the menu items they want. 
